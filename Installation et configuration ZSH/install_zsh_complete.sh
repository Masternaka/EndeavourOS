...
#   zsh-bat, fzf-zsh-plugin, zsh-zoxide, zsh-syntax-highlighting
...
#
# Utilisation rapide:
# 1. Sauvegardez ce script: install-zsh-complete.sh
# 2. Rendez-le exécutable: chmod +x install-zsh-complete.sh
# 3. Exécutez-le: sudo ./install-zsh-complete.sh [options]
#
# Options:
...
#
# Exemples:
#   sudo ./install-zsh-complete.sh --dry-run
#   sudo ./install-zsh-complete.sh --verbose --theme macchiato
#   sudo ./install-zsh-complete.sh --theme-url https://exemple/mon_theme.omp.json
#   sudo ./install-zsh-complete.sh --no-tools
#
# Notes:
...
echo "   - fzf-zsh-plugin (intégration fzf)"
